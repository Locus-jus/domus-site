...
export default function ContatoPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = `mailto:domusoratoriaedebates@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Nome: ${formData.name}\nE-mail: ${formData.email}\n\n${formData.message}`)}`;
    setSubmitted(true);
  };
              ...
              <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-domus-text-secondary">
                           domusoratoriaedebates@gmail.com
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                ...
                <div className="border-t border-domus-border-light pt-8">
                  ...
                  <div className="flex gap-4">
                    <a
                       href="https://instagram.com/domus.sddo"
                       target="_blank"
                       rel="noreferrer"
